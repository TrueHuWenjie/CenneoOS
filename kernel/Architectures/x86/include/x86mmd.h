...
// Virtual Memory
#define MMD_VM_NEW_PD_ADDR  0xfbfe000
#define MMD_VM_NEW_PD_SIZE  MMU_PAGE_SIZE
#define MMD_VM_CUR_PD_ADDR  0xfbff000
#define MMD_VM_CUR_PD_SIZE  MMU_PAGE_SIZE
#define MMD_VM_CUR_PT_ADDR  0xfc00000
#define MMD_VM_CUR_PT_SIZE  4096 * 1024
#define MMD_VM_KNEL_ADDR     0x00000000
#define MMD_VM_KNEL_SIZE     (256 MB - (MMU_PAGE_SIZE * (2 + 1024)))
