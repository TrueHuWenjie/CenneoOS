...
.prepare:
	...
	; Init for stack
	mov		ss, ax
	; Stack top pointer to the top of the segment 0x0000(0xffff)
	mov		esp, STACK_TOP
...
; boot info
boot_info:
	; The identity of boot info structure
	db		"EBI",0x00
...
; loader program's head
_start:
	; this function is located in /boot/arch/x86/_start.asm,
